...
6. Now you can install extension from 'R7.Epsilon-01.00.00-Install.zip' package  
...
1. Move Packages Project/EndProject entry in R7.Epsilon.sln file to the bottom, to ensure
that Packages project will build last. 

2. Add new <package> section to R7.Epsilon.dnn manifest. If you create new extension 
...
3. Merge .SqlDataProvider files of newly created extension with ones in the R7.Epsilon extension (if needed).
