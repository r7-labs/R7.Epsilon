...
<div class="skin-page-info">
    ...
    <% if (EnableSocialShare) { %> <%-- TODO: Add link@rel='canonical' --%> <div class="skin-page-share-buttons">
        ...
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="<%= PortalSettings.ActiveTab.FullUrl %>" data-lang="<%= CultureInfo.CurrentCulture.TwoLetterISOLanguageName %>" data-via="<%= Config.TwitterVia %>">Tweet</a>
