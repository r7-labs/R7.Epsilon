...
<div class="skin-float-box-vertical">
	<a href="#" class="skin-float-btn skin-float-btn-up" style="display:none" title='<%: T.GetString ("ButtonUp_Title.Text") %>' data-toggle="tooltip" data-placement="left" data-container="body">
		<i class="fas fa-chevron-up"></i>
	</a>
	<a href='<%: T.GetString ("AgeRating_Link.Text") %>' target="_blank" class="skin-float-btn skin-float-btn-age-rating"
			title='<%: T.GetString ("AgeRating_Title.Text") %>' data-toggle="tooltip" data-placement="left" data-container="body">
