...
<ul class="skin-socialgroups">
    <li>
        <a class="skin-social-button skin-social-vk" href="<%= Config.Vk.Group %>" target="_blank" title="<%= Localizer.GetString ("VKontakte.Title") %>" aria-label="<%= Localizer.GetString ("VKontakte.Title") %>" ></a>
    </li>
	<li>
        <a class="skin-social-button skin-social-yt" href="<%= Config.Youtube.Group %>" rel="nofollow" target="_blank" title="<%= Localizer.GetString ("Youtube.Title") %>" aria-label="<%= Localizer.GetString ("Youtube.Title") %>"></a>
    </li>
	<li>
