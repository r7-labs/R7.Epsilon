<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Test.ascx.cs" Inherits="R7.Epsilon.Test" %>
...
<dnn:DnnCssInclude runat="server" FilePath="~/Resources/Shared/components/malihu-scroller/jquery.mCustomScrollbar.min.css" />
<dnn:DnnJsInclude runat="server" FilePath="~/Resources/Shared/components/malihu-scroller/jquery.mCustomScrollbar.concat.min.js" ForceProvider="DnnFormBottomProvider" />
...
jQuery(document).ready(function () {
    jQuery(".skin-primary-menu .sub").mCustomScrollbar ({
        theme:"dark", scrollInertia:0,
...
<style type="text/css">
.skin-primary-menu .sub 
{
    max-height:450px;
}

.mCSB_dragger_bar { background-color:#393 }
</style>